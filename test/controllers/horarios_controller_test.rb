...
class HorariosControllerTest < ActionController::TestCase
  ...
  test "should create horario" do
    assert_difference('Horario.count') do
      post :create, horario: { curso_id: @horario.curso_id, dia: @horario.dia, fin: @horario.fin, inicio: @horario.inicio, turno_id: @horario.turno_id }
    end
  ...
  test "should update horario" do
    patch :update, id: @horario, horario: { curso_id: @horario.curso_id, dia: @horario.dia, fin: @horario.fin, inicio: @horario.inicio, turno_id: @horario.turno_id }
    assert_redirected_to horario_path(assigns(:horario))
  end
