...
class TurnosControllerTest < ActionController::TestCase
  ...
  test "should create turno" do
    assert_difference('Turno.count') do
      post :create, turno: { descripcion: @turno.descripcion, hora_fin: @turno.hora_fin, hora_inicio: @turno.hora_inicio }
    end
  ...
  test "should update turno" do
    patch :update, id: @turno, turno: { descripcion: @turno.descripcion, hora_fin: @turno.hora_fin, hora_inicio: @turno.hora_inicio }
    assert_redirected_to turno_path(assigns(:turno))
  end
