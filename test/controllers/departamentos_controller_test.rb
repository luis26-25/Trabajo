...
class DepartamentosControllerTest < ActionController::TestCase
  ...
  test "should create departamento" do
    assert_difference('Departamento.count') do
      post :create, departamento: { descripcion: @departamento.descripcion, nombre: @departamento.nombre, trabajador_id: @departamento.trabajador_id }
    end
  ...
  test "should update departamento" do
    patch :update, id: @departamento, departamento: { descripcion: @departamento.descripcion, nombre: @departamento.nombre, trabajador_id: @departamento.trabajador_id }
    assert_redirected_to departamento_path(assigns(:departamento))
  end
